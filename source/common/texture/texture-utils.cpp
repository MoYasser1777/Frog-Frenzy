...
our::Texture2D *our::texture_utils::empty(GLenum format, glm::ivec2 size)
{
    ...
    texture->bind();
    glTexStorage2D(GL_TEXTURE_2D, 1, format, size.x, size.y); // Set the texture data to NULL to create an empty texture
    // This function is used to allocate memory for textures without specifying the actual data
