...
class loseMenuState: public our::State {
    ...
    std::array<ButtonLose, 2> buttons;
    ...
    void onInitialize() override {
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/textures/lose_menu.png");
        ...
        if (!sound)
            ...
            sound->play2D("./sounds/lose.mp3", true);
    }
